...
const AddPackageModal = (props: TProps) => {
  const [name, setName] = useState("");
  const [price, setPrice] = useState("");
  const [desc, setDesc] = useState("");
  const [category, setCategory] = useState([]);
  const [valCat, setValCat] = useState("category");
  const [cusItem, setCusItem] = useState<ICostumItem[]>([]);
  ...
  return (
    <dialog className="modal" id="add_package_modal">
